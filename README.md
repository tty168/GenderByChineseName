...
`data/hanzi_dictionary.csv` is generated by `python/scan_schema.py`, and contains the character-level structural information used in the project.
...
etymology_type
```
This dictionary provides a convenient character-level lookup source for applications built on top of the learned embeddings.
